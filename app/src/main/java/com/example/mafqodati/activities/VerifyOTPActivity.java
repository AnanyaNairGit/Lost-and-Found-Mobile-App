...
public class VerifyOTPActivity extends AppCompatActivity {
                ...
                FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential)
                        .addOnCompleteListener(task -> {
                            ...
                            if(task.isSuccessful()){
                                Intent intent = new Intent(getApplicationContext(), PickProfilePicture.class);
        ...
        findViewById(R.id.textResendOTP).setOnClickListener(v -> {
            ...
            PhoneAuthOptions options =
                    PhoneAuthOptions.newBuilder()
                            .setPhoneNumber("+962"+getIntent().getStringExtra("mobile"))
    ...
    private void setTextMobile(){
        textMobile.setText(String.format(
                "+962-%s",getIntent().getStringExtra("mobile")
        ));
    }
